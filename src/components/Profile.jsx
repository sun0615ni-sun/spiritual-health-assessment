...
const Profile = ({ onComplete }) => {
  ...
  const validateForm = () => {
    ...
    const requiredFields = [
      'name', 'birthDate', 'gender', 'nationality', 'city', 
          ...
          >
            <Card className="shadow-lg border-0 bg-white/90 backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                ...
                {/* 國籍 */}
                <div className="space-y-2">
                  <Label htmlFor="nationality">國籍 <span className="text-red-500">*</span></Label>
                  <Input
                    id="nationality"
                ...
                {/* 居住城市 */}
                <div className="space-y-2">
                  <Label htmlFor="city">居住城市 <span className="text-red-500">*</span></Label>
                  <Input
                    id="city"
                    value={formData.city}
                ...
                {/* 職業 */}
                <div className="space-y-2">
                  <Label htmlFor="occupation">職業 <span className="text-red-500">*</span></Label>
                  <Input
                    id="occupation"
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.livingStatus} onValueChange={(value) => handleInputChange('livingStatus', value)}>
                    <SelectTrigger className={errors.livingStatus ? 'border-red-500' : ''}>
